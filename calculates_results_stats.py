...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        if results_dic[key][2] == 1:
            ...
            results_stats_dic['n_not_match'] += 1
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_images'] - results_stats_dic['n_not_match'])/ results_stats_dic['n_images']
